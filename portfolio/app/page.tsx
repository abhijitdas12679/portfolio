          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="w-full md:w-80 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {["Agentic AI", "LangChain", "LangGraph", "RAG Systems", "Power BI", "EDA & Analytics", "Python & FastAPI", "Docker", "Docker Compose", "Jenkins", "Amazon Web Services", "Microsoft Azure", "Databricks", "PySpark", "Apache Spark", "SQL Server", "PostgreSQL", "Microsoft SQL Server", "ETL", "Apache Airflow", "Hadoop", "Microsoft Fabric"].map((skill) => (
                  <span
                    key={skill}
